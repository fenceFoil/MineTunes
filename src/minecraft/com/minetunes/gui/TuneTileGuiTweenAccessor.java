 ...
 * 
 */
public class TuneTileGuiTweenAccessor implements TweenAccessor<TuneTileGui> {
	 ...
	 */
	@Override
	public int getValues(TuneTileGui target, int tweenType, float[] returnValues) {
		switch (tweenType) {
		case 1:
...
//			return 1;
	 ...
	 */
	@Override
	public void setValues(TuneTileGui target, int tweenType, float[] newValues) {
		switch (tweenType) {
		case 1:
