...
/**
 * Waits for all mouse buttons to be lifted, then sets a flag in MineTunes.
 *
 */
public class ClickCheckThread extends Thread {
	
	public ClickCheckThread () {
		setName ("MineTunes Click Monitor");
	}
