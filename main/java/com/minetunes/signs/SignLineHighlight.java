...
public class SignLineHighlight extends SignLine {
	private String highlightCode = "";
	
	public SignLineHighlight (Point3D signPoint, int line, String code) {
		super (signPoint, line);
		highlightCode = code;
	}

	/**
	 * @return the highlightCode
	 */
	...
	/**
	 * @param highlightCode the highlightCode to set
	 */
