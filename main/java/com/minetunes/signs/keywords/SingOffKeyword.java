 ...
 * 
 */
public class SingOffKeyword extends SignTuneKeyword {

	public SingOffKeyword(String wholeKeyword) {
		super(wholeKeyword);
	...
	public Point3D execute(Ditty ditty, Point3D location,
		...
		int eventID = ditty.addDittyEvent(new SingOffEvent(ditty.getDittyID()));
